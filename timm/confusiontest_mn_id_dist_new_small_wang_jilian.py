...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="/home/panq/vendor/pytorch-image-models/out/mobilevit/20220711-150539-mobilenetv3_small_100-32/checkpoint-1.pth.tar",
        help="train dir",
    )
    parser.add_argument(
        "-m2",
...
if __name__ == "__main__":
    ...
    net0 = timm.create_model("mobilenetv3_small_100", num_classes=2, in_chans=1).to(
        "cuda"
    )
    ...
    tim.models.helpers.load_checkpoint(net0, args.modelpath)
    ...
    val_loader = torch.utils.data.DataLoader(
        test_set, batch_size=128, shuffle=False, num_workers=8
    )  #  , pin_memory=True
    G.eval()
    C.eval()
    net0.eval()
